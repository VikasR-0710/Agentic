class CaseService:
    ...
    def get_recent_cases(self):
        ...
        SELECT
            ...
            CreatedDate,
            IsPublished from CaseComments where IsPublished=true order by CreatedDate Desc LIMIT 1)
        FROM Case
    ...
    'Shreyas Nambiar', 'Shivendra Yadav', 'Sindhu M Y', 'Sivagnana Bharathi Nagaraj', 'Sivaji Koya', 
